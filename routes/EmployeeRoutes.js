...
app.get('/employees', async (req, res) => {
  ...
  try {
    console.log(employees[4].fullname)
...
app.get('/employee', async (req, res) => {
  ...
  //const employees = await employeeModel.find({_id: req.query.id}).select("firstname lastname salary designation");
  //const employees = await employeeModel.getEmployeeByFirstName(req.query.name)
